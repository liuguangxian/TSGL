...
<body   background="images/nvhai.jpg">
	<table align="center" width="1000" border="2" height="400" bordercolor="#9ED9D5" bgcolor="" cellpadding="1" cellspacing="1">
		<tr bgcolor="">
		...
		<tr align="center" bgcolor="" >
			...
			%>
				<tr align="center" bgcolor="">
					...
					<td>
						<form action="PriceupdataServlet" method="post" onsubmit="return check(this);">
